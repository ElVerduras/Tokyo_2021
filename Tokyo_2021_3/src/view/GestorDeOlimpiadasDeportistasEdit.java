...
public class GestorDeOlimpiadasDeportistasEdit {
	...
	public static void create(JFrame frame,Deportista d) {
					...
					//DISCIPLINE
							...
							DeportistaEnDisciplina d_d=new DeportistaEnDisciplina();
			        		DisciplinaDAO dis_bbdd = FactoryDAO.getDisciplinaDAO();
			        		DeportistaEnDisciplinaDAO d_d_ddbb=FactoryDAO.getDeportista_en_disciplinaDAO();
