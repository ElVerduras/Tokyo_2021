...
import csv.GenerarCsv;
import dao.DeportistaDAO;
import dao.DeportistaEnDisciplinaDAOjdbc;
...
public class GestorDeOlimpiadasDeportista {
	...
	public static void create(JFrame frame) {
			        ...
			        Button_New.addActionListener( new ActionListener(){
			        	@Override
			 			 public void actionPerformed(ActionEvent e) {
			        		frame.dispose();
			        		GestorDeOlimpiadasNuevoDeportista.createWindow();
        ...
        DeportistaEnDisciplinaDAOjdbc d_d_ddbb = new DeportistaEnDisciplinaDAOjdbc();
	    ...
	    for (int i = 0; i< listaDeportista.size(); i++) {
	       ...
	       Action editar = new AbstractAction(){
	    	   public void actionPerformed(ActionEvent e) {
	    		   ...
	    		   GestorDeOlimpiadasDeportistasEdit.createWindow(d_aux);
	       ...
	       public void actionPerformed(ActionEvent e) {
	    	   JTable tabla = (JTable)e.getSource();
	    	   Confirmation.createWindow(e,tabla);
	            /*
